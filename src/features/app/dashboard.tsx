...
export function Dashboard() {
  ...
  const backgroundSettings = focusMode && appearance.backgroundKind === "lottie"
    ? { ...appearance, brightness: Math.max(appearance.brightness, 90), overlay: Math.min(appearance.overlay, 18) }
    : appearance;
